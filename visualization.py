...
def visualEmdResult():
    ...
    VAE_nvib_old = '../results/VAE_nvib_old/KDTreeVAE_nvib_old/EMD/emd_.npy'
    ...
    VAE_nvib_old_data = np.load(VAE_nvib_old)
    ...
    plt.plot(x, y24, 'g-', linewidth=1.5, label='VAE_nvib_old')
